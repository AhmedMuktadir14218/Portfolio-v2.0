        ...
        lg:item-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <div className='flex-1'>
            ...
            <p className='mb-6'>
              ...
              - Conversion of PSD/Figma/XD/Sketch to HTML or React Websites.

- Creating fully responsive frontend websites.

- Redesigning or recreating existing websites.

- Customizing web elements to suit your specific needs
            </p>

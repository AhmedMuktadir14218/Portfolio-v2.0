      ...
      <div className="container  mx-auto">
        ...
        lg:item-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <div className='flex-1'>
            ...
            <p className='mb-6'>
            I am 22 year's old .And  I am a Full stack Web Developer. I am from Savar, Dhaka. Now I live in Farmgate. . From My childhood I dreamed to be an engineer . Already I have started my journey. Currently, I'm studying in computer science and engineering from Daffodil International University.

      ...
      <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
        <div className='flex-1 text-center font-secondary lg:text-left'>
          ...
          <motion.div 
           ...
           whileInView={'show'}
           viewport={{once: false,amount:0.7}}
          className='mb-6 text-[24px] lg:text-[32px] font-secondary font-semibold uppercase leading-[1]'>
          ...
          className='mb-8 max-w-lg mx-auto lg:mx-0'>
           Muktadir Udoy | Expert Web Developer Exceed your web development expectations with over 3 years of experience. Proficient in HTML, CSS, JavaScript, ReactJS, Node js, Express js, and MongoDB. Let's bring your ideas to life! Client satisfaction guaranteed.</motion.p>
          <motion.div

      ...
      <div className="container mx-auto">
        ...
        <div className='flex flex-col lg:flex-row gap-x-10 '>
          ...
          className='flex-1 flex flex-col gap-y-10 '>
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'><span className='text-gradient '>BookWorms</span></div>
              <div  className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z5'><span className='text-3xl text-white'>Online Book Store</span></div>
            </div>

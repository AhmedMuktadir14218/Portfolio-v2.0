      ...
      <div className="container  mx-auto">
        ...
        lg:item-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          <div className='flex-1'>
            ...
            <p className='mb-6'>
              I am Muktadir Udoy, an experienced Frontend Web Developer with mastery in React Js, HTML, CSS, JavaScript, and Bootstrap. I take pride in transforming designs into pixel-perfect frontend websites. My code is well-structured, cross-browser compatible, valid, adaptive, and easy to maintain.
            </p>
